...
rails generate scaffold Person firstName:string middleName:string lastName:string family:references emails:references phoneNumbers:references tags:references birthday:string date_deleted:string is_deleted:integer nickName:string
